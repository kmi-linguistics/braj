...
model = input ('Model for Prediction (ud/bis): ')
model = model.strip().lower()

if model == 'ud' or model == 'bis':
	model_file = 'models/' + lang + '_' + model + '_pos_model.pkl'
	try:
	...
	print ('Model name not known. Please enter either "bis" or "ud" as the model for prediction')
